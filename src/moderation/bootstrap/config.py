...
DEFAULT_DB_URI = "sqlite+aiosqlite:///moderation.db"
...
def get_alembic_config() -> AlembicConfig:
    resource = files("moderation.infrastructure.persistence.alembic")
...
def get_uvicorn_config() -> UvicornConfig:
    return UvicornConfig(
        environ.get(
            "SERVER_FACTORY_PATH",
            "moderation.bootstrap.entrypoints.api:bootstrap_application",
        ),
